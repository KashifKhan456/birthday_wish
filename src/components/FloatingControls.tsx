...
export default function FloatingControls({
  ...
  return (
    <>
      ...
      <div className="floating-controls fixed top-3 md:top-auto bottom-auto md:bottom-6 right-4 md:right-6 z-999 flex flex-col gap-3">
        <button
      ...
      <div className="floating-left-controls fixed top-3 md:top-auto bottom-auto md:bottom-6 left-4 md:left-6 z-999">
        <button
