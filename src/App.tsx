  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden flex flex-col items-center justify-between py-6">
      ...
      {/* ==========================================================================
           ...
           ========================================================================== */}
      <main
        className={`w-full max-w-4xl mx-auto px-4 z-10 flex flex-col items-center justify-center min-h-[55vh] md:min-h-[85vh] pt-6 md:pt-0 transition-all duration-700 ${
